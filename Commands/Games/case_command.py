...
class Case():
    def __init__(self, server_id):
        ...
        self.is_souvenir = self.case["type"] == "Souvenir"
    ...
    def open_case_get_weapon(self):
        ...
        gun_float, wear_level, weapon_name, weapon_pattern, is_stattrak = self.process_weapon_info(
            weapon_info)
    ...
    def create_weapon(self, weapon_info, gun_float, wear_level, weapon_name, weapon_pattern, is_stattrak, prices):
        return self.utility.create_weapon_from_info(
            ...
            weapon_info["image"], is_stattrak, self.color, prices)
    ...
    async def send_embed_message(self, embed, interactions, weapon):
        ...
        await self.utility.add_buttons(
            ...
            function_keep=lambda interactions: self.process_action(
                interactions, weapon, embed_message, "keep"),
            function_sell=lambda interactions: self.process_action(
                interactions, weapon, embed_message, "sell"),
            weapon=weapon
        )
